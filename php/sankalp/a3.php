...
<head>
	<meta charset="utf-8">
	<title>9-12 U.P. & C.B.S.E. Board</title>
	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">9-12 U.P. & C.B.S.E. Board
						</div>
