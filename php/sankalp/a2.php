...
<head>
	<meta charset="utf-8">
	<title>B.Sc & B.Com Regular Classes</title>
	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">B.Sc & B.Com Regular Classes
						</div>

						<div style="margin-top: 40px;margin-left: 50px;">
							<img src="img/fee2.png" height="650">
						</div>
