	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">Fee details
						</div>

						<div style="margin-top: 50px;margin-left: 90px;">
							<img src="img/fee.png" ><br><br>
							<img src="img/fee1.png">
						</div>
