	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">B.Ed_2018
						</div>

						<table border="1" style="margin: 20px;">
							<tr style="margin: 20px;"><h3 style="font-weight: bold;">B.Ed_2018</h3>
								<td style=" float: left;margin: 20px 10px 10px 10px; "> <img src="img/bed/1.jpg" height="250" width="380"></td>
							
							
								<td style=" float: left; margin: 20px 10px 10px 10px;"><img src="img/bed/2.jpg" height="250" width="380"></td>
							</tr>
							<tr style="margin: 20px;">
								
								<td style=" float: left;margin: 20px 10px 10px 10px;"><img src="img/bed/3.jpg" height="250" width="380"></td>

								<td style=" float: left;margin: 20px 10px 10px 10px;"><img src="img/bed/4.jpg" height="250" width="380"></td>
							</tr>
							<tr style="margin: 20px;">
								
								<td style=" float: left;margin: 20px 10px 10px 10px;"><img src="img/bed/5.jpg" height="250" width="380"></td>

								<td style=" float: left;margin: 20px 10px 10px 10px;"><img src="img/bed/6.jpg" height="250" width="380"></td>
							</tr>
