...
<head>
	<meta charset="utf-8">
	<title>U.P.-T.E.T. & C.T.E.T. Competative Exam Preparation</title>
...
<body>
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<img src="img/04.jpg" height="400" width="1200"><br><br>			
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">U.P.-T.E.T. & C.T.E.T. Competative Exam Preparation
						</div>

						<div >
							<p style="margin:20px 15px;font-size:large;  font-weight:bold;"><span><img src="img/icon.png" height="60"></span>PROCEDURE OF COACHING</p>
							<ul>Sankalp Tutorials is promoted with a view to impact quality education with the help of Dedicated and expert faculty members.<br><br>
								<li style="margin-top: 5px;">Daily 3 to 4 periods are held.</li>
								<li style="margin-top: 5px;">All the subjects are thought.</li>
								<li style="margin-top: 5px;">Each topic of each subject is well to described with easy technique so that even weakest student can understand.</li>
								
							</ul>
							<p style="margin:20px 15px;font-size:large;  font-weight:bold;"><span><img src="img/icon.png" height="60"></span>SPECIAL FEATURES</p>
						</div>
						<ul>
							<li style="margin-top: 5px;">Enriched Course Materials</li>
								<li style="margin-top: 5px;">Very Similar Test Pattern</li>
								<li style="margin-top: 5px;">Question Bank (More than 5000)</li>
								<li style="margin-top: 5px;">Important Test Series</li>
						</ul>
						<div style="margin-top: 20px; margin-left: 50px;">
							<img src="img/t.png">
							<img src="img/t1.png">
						</div>
						<pre style="height:50px;width: 700px; margin-left:50px;">
							<span style="color: #1523;" >Sankalp Tutorials is a premier institute in the field of one day government exams such as SSC, BANKING, RAILWAY, B.Ed., TET, TGT, BHU, CHS, POLICE etc in varanasi. ctet preparation in varanasi, up tet preparation in varanasi, up tet ctet coaching in varanasi, ctet up ctet institute in varanasi, best ctet up tet coaching in varanasi, Enroll for CTET Coaching Classes in Varanasi. Find Central Teacher Eligibility Test training centres, tutoring classes, Institutes in varanasi and get CTET trainers, instructors, tutors in varanasi. 
