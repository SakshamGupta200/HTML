	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">IITJEE-NEET-FOUNDATION
						</div>

						<div style="margin-left:50px; margin-top:50px;" >
							<img src="img/iit.png" width="800" ><br><br>
							<img src="img/iit2.png" width="800" >	
						</div>		
