...
<head>
	<meta charset="utf-8">
	<title>SI, SSC, Bank, Railway Competative Exam Preparation</title>
	...
	<div class="container-fluid" style="margin-left: 50px;">
       ...
       <div>
			...
			<div class="container-fluid" style="margin-left: -15px;">
				<div class="row">
					<div class="col-md-9">
						<div style="background-color:olive; padding-left: 10px; height:50px;font-size: xx-large;font-weight: bolder;color: white; ">SI, SSC, Bank, Railway Competative Exam Preparation Preparation
						</div>
						...
						<div >
							...
							<ul>Sankalp Tutorials is promoted with a view to impact quality education with the help of Dedicated and expert faculty members.<br><br>
								...
								<li style="margin-top: 5px;">Weekly Test Series</li>
								<li style="margin-top: 5px;">Group Discussion</li>
						...
						<div style="margin-left: 30px;">
							<p style="font-size: large;font-weight: bold;"> <img src="img/icon.png">Faculties</p>
							<img src="img/ssc.png">
						</div>					
