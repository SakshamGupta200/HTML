...
<div class= "outer">
<div class="banner"> 
<img src="image/logol.jpg" height="200" width="900"></div>
<div class="work">
	<div class="menu">
	...
	<div class="part">
		...
		<div>
			...
			<select>
				...
				<option>CS</option>
				<option>Elect</option>
			</select>&nbsp;&nbsp;<button class="btn-success">View</button>
Student Name : <input type="text" name="">&nbsp;&nbsp;<button class="btn-success">View</button>
		</p>
